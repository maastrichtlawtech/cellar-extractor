...
FIELD_MANIFEST: List[Dict[str, Any]] = [
    ...
    _entry("sector", "CELEX sector. 0 consolidated, 3 secondary legislation, 6 CJEU case law, 8 national case law, etc.",
           source="cdm", source_uri="resource_legal_id_sector", type_="string", sector_affinity="any",
           example="6"),
    _entry("resource_legal_type", "CELEX type-letter (CJ, CO, CC, R, L, D, …).",
           source="cdm", source_uri="resource_legal_type", sector_affinity="any",
           example="CO"),
    _entry("year_of_resource", "Year embedded in the CELEX.",
           source="cdm", source_uri="resource_legal_year", type_="integer", sector_affinity="any",
           example="2023"),
    _entry("natural_number_celex", "Numeric tail of the CELEX (e.g. 800 for 62023CO0800).",
           source="cdm", source_uri="resource_legal_number_natural_celex", type_="integer", sector_affinity="any",
           example="800"),
    _entry("local_identifier", "Court-issued local identifier (national case numbers etc.).",
           source="cdm", source_uri="resource_legal_id_local", sector_affinity="sector_8",
    ...
    # B. Document type
    # -----------------------------------------------------------------------
    _entry("resource_type", "Document type label resolved via skos:prefLabel — Judgment, Order, Opinion of the Advocate General, Decision, Regulation, Directive, etc.",
           source="cdm", source_uri="work_has_resource-type", cardinality="multi", sector_affinity="any",
           example="Order"),
    ...
    _entry("date_signature", "Date the legal act was signed.",
           ...
           example="2016-04-27"),
    _entry("date_end_of_validity", "End-of-validity date (often 9999-12-31 = act still active).",
           source="cdm", source_uri="resource_legal_date_end-of-validity", type_="date", sector_affinity="legislation",
           example="9999-12-31"),

    # -----------------------------------------------------------------------
    # D. Court / parties / agents
    # -----------------------------------------------------------------------
    _entry("delivered_by_court_formation", "Court formation that delivered the judgment, e.g. Tenth Chamber, Grand Chamber.",
           source="cdm", source_uri="case-law_delivered_by_court-formation", sector_affinity="case_law",
           example="Tenth Chamber"),
    _entry("commented_by_agent", "Member states / EU institutions that submitted observations.",
           source="cdm", source_uri="case-law_commented_by_agent", cardinality="multi", sector_affinity="case_law",
           example="Belgium;EU institutions and bodies;European Commission"),
    _entry("advocate_general", "Surname (with optional initial) of the Advocate General — InfoCuria-resolved name.",
           source="infocuria", source_uri="advocateML", sector_affinity="case_law",
           example="Campos Sánchez-Bordona"),
    _entry("judge_rapporteur", "Surname of the Judge Rapporteur — InfoCuria-resolved name.",
           source="infocuria", source_uri="reportingJudgeML", sector_affinity="case_law",
           example="Smulders"),
    ...
    _entry("language_procedure", "Procedural language.",
           ...
           example="Dutch"),
    _entry("origin_country", "Country of origin (referring court for preliminary rulings, action-respondent for direct actions).",
           source="cdm", source_uri="case-law_originates_in_country", cardinality="multi", sector_affinity="case_law",
           example="Belgium"),
    _entry("origin_country_or_role_qualifier", "Country of origin enriched with role qualifier (respondent / applicant).",
           source="cdm", source_uri="case-law_originates_in_country_role-qualifier", cardinality="multi", sector_affinity="case_law",
           example="Belgium"),
    _entry("conclusions", "Reference (CELLAR URI) to the Advocate-General's Opinion linked to this case.",
           source="cdm", source_uri="case-law_has_conclusions_opinion_advocate-general", sector_affinity="case_law",
           example="http://publications.europa.eu/resource/cellar/8e01d479-…"),
    _entry("legal_resource", "Legal resource (statute, treaty article, regulation, …) the case interprets.",
           source="cdm", source_uri="case-law_interpretes_resource_legal", cardinality="multi", sector_affinity="case_law",
           example="http://publications.europa.eu/resource/cellar/4fd758c9-…"),

    # -----------------------------------------------------------------------
    # F. Subject matter / classification
    # -----------------------------------------------------------------------
    _entry("subject_matter", "Top-level subject matter taxonomy.",
           source="cdm", source_uri="resource_legal_is_about_subject-matter", cardinality="multi", sector_affinity="any",
           example="Free movement of goods;Customs Union and Common Customs Tariff"),
    _entry("directory_codes", "EUR-Lex case-law directory codes (LCMA, FISC, …).",
           source="infocuria", source_uri="matCode", cardinality="multi", sector_affinity="case_law",
           example="DFON;LCMA;PRIN"),
    _entry("eurovoc", "EuroVoc concept labels (resolved EN).",
    ...
    # -----------------------------------------------------------------------
    _entry("eli", "European Legislation Identifier — canonical URL of the act.",
           source="cdm", source_uri="resource_legal_eli", type_="url", sector_affinity="legislation",
           example="http://data.europa.eu/eli/reg/2016/679/oj"),
    _entry("in_force", "Boolean flag: is the act still in force?",
           source="cdm", source_uri="resource_legal_in-force", type_="boolean", sector_affinity="legislation",
           example="1"),
    _entry("is_eea_relevant", "Boolean flag: is the act EEA-relevant?",
           source="cdm", source_uri="resource_legal_eea", type_="boolean", sector_affinity="legislation",
           example="1"),
    _entry("is_codified_version", "Boolean flag: is this act a codified version?",
           source="cdm", source_uri="resource_legal_codified_version", type_="boolean", sector_affinity="legislation",
           example="0"),
    _entry("repertoire", "Repertoire-of-legislation-in-force flag (REP).",
           source="cdm", source_uri="resource_legal_repertoire", sector_affinity="legislation",
           example="REP"),
    _entry("oj_reference", "Compact OJ reference (e.g. 2024/1689).",
           source="cdm", source_uri="resource_legal_reference_oj-act", sector_affinity="legislation",
           example="2024/1689"),
    _entry("oj_domain_reference", "OJ act domain (e.g. EU).",
           source="cdm", source_uri="resource_legal_domain_reference_oj-act", sector_affinity="legislation",
           example="EU"),
    _entry("manuscript_ref", "Manuscript reference for the OJ submission.",
           source="cdm", source_uri="resource_legal_manuscript_ref", sector_affinity="legislation",
           example="PE 17 2016 INIT"),
    _entry("responsibility_agent", "Responsible Commission DG / agent.",
           source="cdm", source_uri="resource_legal_responsibility_of_agent", cardinality="multi", sector_affinity="legislation",
           example="Eurostat;Directorate-General for Justice and Consumers"),
    _entry("internal_status_code", "Internal CMR status code (MAN1, MAN2, …).",
           source="cdm", source_uri="resource_legal_comment_internal", sector_affinity="legislation",
           example="MAN2"),
    ...
    # -----------------------------------------------------------------------
    _entry("citing", "CELEX ids of works this document cites (out-edges).",
           source="enrichment", cardinality="multi", sector_affinity="any",
           example="32012Q0929(01);62015CO0328"),
    _entry("cited_by", "CELEX ids of works that cite this document (in-edges).",
           source="enrichment", cardinality="multi", sector_affinity="any",
           example="62025CO0114"),
    _entry("affecting_ids", "Clean published case numbers of affecting cases (joined / appealed / re-examined / transferred).",
           source="infocuria", cardinality="multi", sector_affinity="case_law",
           example="C-73/24"),
    _entry("affecting_string", "Affecting cases prefixed with relation kind: joined / appeal_against / appealed_in / re-examines / re-examined_in / transfers / transferred_from.",
           source="infocuria", cardinality="multi", sector_affinity="case_law",
           example="joined: C-73/24"),
    _entry("citations_extra_info", "Composite of party names + procedure result type (free-text).",
           source="infocuria", sector_affinity="case_law",
           example="DRINKS 52;Reference for a preliminary ruling: dismissal on grounds of inadmissibility"),

    # -----------------------------------------------------------------------
    # J. Texts and provenance
    # -----------------------------------------------------------------------
    _entry("summary", "Plain-text summary of the case (preliminary-ruling summary, judgment abstract). Sector 6 only.",
           source="infocuria", sector_affinity="case_law",
           example="Summary C-800/23 — 1\nCase C-800/23\n…"),
    _entry("text_source", "Provenance of the full text: INFOCURIA_BLOB_HTML, CELLAR_ITEM, CELLAR_REST_XHTML, EXTRACTOR_FALLBACK_TEXT, or empty.",
           source="enrichment", sector_affinity="any",
           example="INFOCURIA_BLOB_HTML"),
    _entry("text_format", "html, xhtml, pdf, xml, or empty.",
           source="enrichment", sector_affinity="any",
           example="html"),
    _entry("text_language", "ISO-639-1 language code of the full text (EN, DE, …).",
           source="enrichment", sector_affinity="any",
           example="EN"),
    _entry("summary_source", "Provenance of the summary: INFOCURIA_DOCUMENT_CONTENT, INFOCURIA_AFF_OBJECT, CELLAR_SUMMARY_ITEM, or empty.",
           source="enrichment", sector_affinity="case_law",
           example="INFOCURIA_DOCUMENT_CONTENT"),
    _entry("summary_language", "Language of the summary text.",
           source="enrichment", sector_affinity="case_law",
           example="EN"),
    _entry("fulltext_source", "Mirror of text_source written into the metadata CSV column for backwards compatibility.",
           source="enrichment", sector_affinity="any",
           example="INFOCURIA_BLOB_HTML"),
    _entry("missing_reasons", "`;`-joined flags marking absent upstream content. Empty when retrieval was complete.",
           source="enrichment", cardinality="multi", sector_affinity="any",
...
ENRICHMENT_CANONICAL_COLUMNS = tuple(
    field["name"] for field in FIELD_MANIFEST
