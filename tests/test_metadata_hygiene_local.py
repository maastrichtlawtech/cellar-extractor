...
def test_sector8_keywords_and_eurovoc_stay_empty(monkeypatch):
    ...
    monkeypatch.setattr(
        es, "_fetch_sector8_subject_labels",
...
def _bindings_response(key_field, key_value):
    ...
    return {"results": {"bindings": [
        ...
        binding("case_law_is_about_concept_case_law", "uri://c1", label="Provisional data"),
...
def test_placeholder_filtered_in_celex_metadata(monkeypatch):
    monkeypatch.setattr(cq, "_query_with_retries",
